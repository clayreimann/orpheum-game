...
class SnowballMenu: SKNode {
    ...
    override init() {
        ...
        let easyButton = SKShapeNode(rect: CGRect(x: 450, y: 400, width: 70, height: 50), cornerRadius: 4)
        ...
        easyButtonLabel.position = CGPoint(x: 485, y: 400)
        ...
        let mediumButton = SKShapeNode(rect: CGRect(x: 450, y: 315, width: 70, height: 50), cornerRadius: 4)
        ...
        mediumButtonLabel.position = CGPoint(x: 485, y: 335)
        ...
        let hardButton = SKShapeNode(rect: CGRect(x: 450, y: 205, width: 70, height: 50), cornerRadius: 4)
        ...
        hardButtonLabel.position = CGPoint(x: 485, y: 205)
        ...
        let backToMenuButton = SKShapeNode(rect: CGRect(x: 450, y: 155, width: 70, height: 50), cornerRadius: 4)
...
//        for touch in touches {
//            if name == "exitButton" {
//                MenuScene.removeFromParent(self)
//            }
//
//            
